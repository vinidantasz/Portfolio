      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/ia.png"
              alt="Projeto de resumo via IA"
            />
            <div class="buttons">
              <a href="https://github.com/vinidantasz/ResumoIA" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="https://ibb.co/pBG9ZwLd"
                  viewBox="0 0 24 24"
                  width="24"
                  height="24"
                >
              ...
              <a href="https://luminous-alfajores-3953ba.netlify.app" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="https://ibb.co/pBG9ZwLd"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Resumo via IA com palavras chaves.
          </p>
        ...
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/saude.png"
              alt="Imagem tema do site."
            />
            <div class="buttons">
              <a href="https://github.com/vinidantasz/Nutri" target="_blank" title="Repositório no Github">
                <svg
              ...
              <a href="https://zippy-nasturtium-5aeb6a.netlify.app/" id="desafio" title="Ver Projetos">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
            Sistema feito com Inteligência Artificial para resumo médico.
          </p>
          <p>TYPESCRIPT - REACT</p>
        </div>
